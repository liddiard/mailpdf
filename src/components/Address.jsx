 ...
 * on the envelope.
 */
const Address = ({ fileUploadHasBegun, from, fields, updateAddress }) => {
  ...
  return (
    <form className={className} autoComplete="off">
      ...
      <input type="text" name="name" placeholder="Name" required
             className={nameClassName} value={fields.name || ''}
             onChange={handleInputChange} tabIndex={tabIndex} />
      <input type="text" name="line1" placeholder="Address line 1" required
             className={line1ClassName} value={fields.line1 || ''}
             onChange={handleInputChange} tabIndex={tabIndex} />
      ...
      <div className="third-line">
        <input type="text" name="city" placeholder="City" required
               className={cityClassName} value={fields.city || ''}
               onChange={handleInputChange} tabIndex={tabIndex} />
        <input type="text" name="state" placeholder="State" required
               className={stateClassName} value={fields.state || ''}
               onChange={handleInputChange} tabIndex={tabIndex} />
        <input type="text" name="zip" placeholder="Zip" pattern="\d*" required
               className={zipClassName} value={fields.zip || ''}
               onChange={handleInputChange} tabIndex={tabIndex} />
      </div>
    </form>
  )
